  ...
  if($_POST['more_number'] == '3')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <p>​Apply - это потолки нового поколения. Особенностью этих потолков - это декоративные вырезы на натяжном полотне.
            <br><br>
            Технология резных натяжных потолков Apply позволяет художественно оформить потолок совершенно новым способом отличным от всех ранее существующих.
            <br><br>
            Можно изобразить цветы, фигуры,бабочек, лунную поверхность, разные сетки… все, что угодно.
            Игрой художественных вырезов, света и цвета, а также отражения, можно задать тему, которая будет повторяться в интерьере.
            За счет художественных вырезов вокруг люстры и светильников можно создавать имитацию декоративной розетки
            Выбирая любой рисунок из нашего каталога или предлагая свой дизайн, Вы получаете красивейший интерьер, создающий уют и настроение в Вашем доме. Рисунки можно комбинировать между собой, умножать и масштабировать.
            <br><br>
            <img src="img/block4/more/1.jpg"/>
            <br><br>
            Потолки APPLY - это комбинация полотна с вырезами и цельного полотна, расположенных вместе или разнесенные на разные уровни. Пленки прикладываются друг к другу. APPLY- в переводе с английского - «приложить», «прикладывать». Так и родилось название стиля.
            <br><br>
            APPLY позволят Вам:
            <br>
            реализовать необычный проект и композицию;<br>
            выполнить вырезы разных размеров и форм;<br>
            создать многоуровневую необычную систему с применением разных цветов и фактур;<br>
            создавать высокохудожественные потолки или потолки с объемным эффектом, применяя принцип «пленка вместе» или «пленка раздельно»;<br>
            решить иногда возникающую задачу «залипания » и «надувания»;<br>
            создать световые художественные потолки.<br>
            Мы поможем разработать проект потолка в стиле APPLY  и подобрать гармоничные сочетания цветов пленки. 
            <br><br>
            <img src="img/block4/more/2.jpg"/>
            <br><br>
            APPLY - прорыв в мире декора. Никто еще не мог представить себе натяжные потолки с вырезами, и не посягался превратить их в искусство.
  ...
  if($_POST['more_number'] == '5')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <br><br>
            Кроме того, пленка Cold Stretch, как и обычные ПВХ-потолки:</p>
            <ul class="text-left">
              <li>пожаробезопасна (не поддерживает горение);</li>
              <li>экологична (в процессе эксплуатации не выделяет токсичных веществ);</li>
              <li>нетребовательна в уходе;</li>
              <li>долговечна.</li>
            </ul>
            <p>Оставьте заявку прямо сейчас в течении 5 минут с Вами свяжется эксперт,
            предложит несколько вариантов решения и сориентирует по цене</p>
            <form action="javascript:void(0);">
              <input type="text" id="more_name" placeholder="Ваше имя">
              <input type="text" id="more_phone" required placeholder="Ваш телефон*"><br />
